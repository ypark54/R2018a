      ...
      protected:
        ...
        CG::Fcn* externFcn(const std::string &name,
            ...
            for(unsigned int i=0; i<numInputs; i++) {
                ...
                inputNamesArr.set(i, cg_string_create(context(), inputNames[i].c_str()) );
            }
            ...
            for(unsigned int i=0; i<numOutputs; i++) {
                ...
                outputNamesArr.set(i, cg_string_create(context(), outputNames[i].c_str()) );
            }
        ...
        CG::Fcn* createTlcFcn(const std::string& name, CG::Type* outType=0, CG::Type* inType1=0, CG::Type* inType2=0) {
            CG::FcnBuilder* fcnPtr = cg_fcn_create_start2(context(), name.c_str(), cg_ctx_global_scope(context()));
            if(outType) {
            ...
            CG::Fcn* newFcn = CG::Fcn::cast(cg_fcn_create_end(fcnPtr));
            cg_fcn_called_in_tlc(newFcn);
            return newFcn;
        }
        ...
        IdxRef getErrorBuffer(const DSPCG::ConstructionFacade::IdxVal &hostLib) {
            ...
            // represented in CGIR
            rslt->setGlobalIndependent(true);
