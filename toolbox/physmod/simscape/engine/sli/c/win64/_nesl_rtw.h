...
mc_csparse_cond(const void *mcLaData);
#ifdef __cplusplus
}
#endif /* __cplusplus */
#include "pm_std.h"
...
extern "C" {
#endif /* __cplusplus */
typedef unsigned int NeDsEquationFlag;typedef unsigned int NeDsVariableFlag;
typedef struct NeDsEquationDataTag{const char *mFullPath;size_t mIndex;
...
boolean_T mIsDifferential;boolean_T mIsFrequency;boolean_T mIsExternal;const
...
*mDescription;size_t mIndex;size_t mM;}NeParameterData;
#ifdef __cplusplus
}
#endif /* __cplusplus */
#include "pm_inline.h"
...
NE_INTEG_EQ_FLAG= 1<<6,NE_NO_EQ_FLAGS= 0};enum{NE_NODAL_VAR_FLAG= 1<<0,
NE_OUTPUT_VAR_FLAG= 1<<1,NE_INPUT_VAR_FLAG= 1<<2,NE_SIGNAL_VAR_FLAG= 1<<3,
NE_TIME_VAR_FLAG= 1<<4,NE_INTEG_VAR_FLAG= 1<<5,NE_NO_VAR_FLAGS= 0};typedef
...
}PMF_DEPLOY_STATIC PmRealVector nesl_get_tolerances(const NeslSimulationData *
sd){return *(sd->mTolerances(sd));}PMF_DEPLOY_STATIC PmSparsityPattern
...
PMF_DEPLOY_STATIC void nesl_set_cstate_has_changed(const NeslSimulationData *
sd,boolean_T value){*(sd->mCstateHasChanged(sd))= value;}PMF_DEPLOY_STATIC
boolean_T nesl_get_cstate_has_changed(const NeslSimulationData *sd){return *(
sd->mCstateHasChanged(sd));}PMF_DEPLOY_STATIC boolean_T nesl_has_sample_hits(
...
return true;}}return false;}typedef struct McSparseMatrixTag McSparseMatrix;
struct McSparseMatrixTag{PmSparsityPattern *mPattern;PmRealVector *mPr;};
McSparseMatrix *mc_assemble_sparse_matrix(const PmSparsityPattern *patternPtr,
const PmRealVector *prPtr,PmAllocator *allocatorPtr);void
...
GmtMethodOutputTag{PmIntVector mMODE;PmRealVector mY;PmIntVector mASSERT;
PmRealVector mINIT_R;PmIntVector mINIT_I;PmRealVector mCACHE_R;PmIntVector
mCACHE_I;PmRealVector mUPDATE_R;PmIntVector mUPDATE_I;PmIntVector mDP_L;
PmIntVector mDP_I;PmIntVector mDP_J;PmRealVector mDP_R;PmRealVector mINIT_DIFF
;}GmtMethodOutput;typedef enum GmtMethodIdTag{GMT_INVALID_METHOD_ID= -1,
GMT_METHOD_MODE,GMT_METHOD_Y,GMT_METHOD_ASSERT,GMT_METHOD_INIT_R,
...
GMT_NUM_METHODS];size_t mNumY;size_t mNumAssertions;const NeAssertData *
mAssertData;size_t mNumRanges;const NeRange *mRanges;NeParameterInfo
mParameterInfo;PmIntVector *mModeIndices;};typedef struct
SwitchedLinearClumpTag SwitchedLinearClump;typedef union SlcMethodOutputTag{
PmSparsityPattern mM_P;PmRealVector mM;PmSparsityPattern mJ_P;PmRealVector mJ;
PmRealVector mF;PmIntVector mMODE;}SlcMethodOutput;typedef enum SlcMethodIdTag
{SLC_INVALID_METHOD_ID= -1,SLC_METHOD_M_P,SLC_METHOD_M,SLC_METHOD_J_P,
SLC_METHOD_J,SLC_METHOD_F,SLC_METHOD_MODE,SLC_NUM_METHODS}SlcMethodId;typedef
int32_T(*SlcMethod)(const SwitchedLinearClump *,const NeDynamicSystemInput *,
SlcMethodOutput *);struct SwitchedLinearClumpTag{SlcMethod mMethods[
SLC_NUM_METHODS];size_t mMNnz;size_t mJNnz;PmIntVector *mStateIndices;
PmIntVector *mModeIndices;PmIntVector *mMRefIndices;PmIntVector *mQRefIndices;
boolean_T mIsModeBoolean;boolean_T mIsMRefBoolean;boolean_T mIsQRefBoolean;
boolean_T mIsDRefNonEmpty;};typedef struct DifferentialClumpTag
...
mMRefIndices;PmIntVector *mQRefIndices;boolean_T mIsMRefBoolean;boolean_T
mIsQRefBoolean;boolean_T mIsDRefNonEmpty;};typedef struct
...
mClumps;DifferentialClump *mDiffClump;void(*mDestroy)(SwitchedLinearSystem *
sls);};
#ifdef __cplusplus
}
#endif /* __cplusplus */
...
SimulatorData;struct SimulatorTag{size_t mNumInputs;size_t mNumStates;size_t
mNumOutputs;double mStepSize;const NeParameterInfo *mParameterInfo;
SimulatorData *mData;void(*mStart)(const Simulator *solver,const
NeParameterBundle *bundle);boolean_T(*mSolve)(const Simulator *solver,const
PmRealVector *inputs,const PmRealVector *states,const PmRealVector *outputs,
real_T time,const NeuDiagnosticManager *mgr,boolean_T firstOutput);boolean_T(*
mCheck)(const Simulator *solver,const PmRealVector *inputs,const PmRealVector *
states,real_T time,const NeuDiagnosticManager *mgr);void(*mDestroy)(Simulator *
solver);};Simulator *simulator_create(SwitchedLinearSystem *sls,const
NeSolverParameters param,const McLinearAlgebra *la);
#ifdef __cplusplus
}
#endif /* __cplusplus */
