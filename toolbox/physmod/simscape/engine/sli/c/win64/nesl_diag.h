/******************************************************************************
 ** File: nesl_rtw_diag.h
 ** Abstract: diagnostic utilities
 **
 ** Copyright 2013-2017 The MathWorks, Inc.
 ******************************************************************************/

#ifndef __nesl_rtw_diag_h__
#define __nesl_rtw_diag_h__
...
/* error_buffer_is_empty() gets the value returned by TLC LibGetRTModelErrorStatus(). 
   Normally, TLC returns an RTM field of type const char*, but per g1417602, it may 
   short-circuit to (void*)0. Declaring const void* seems work in either case. 
*/
