...
4];typedef struct NeLoggerBuilderTag NeLoggerBuilder;typedef enum
...
NeVariabilityType;typedef struct NeSystemInputTag{PmIntVector mQ;PmIntVector mM
;PmRealVector mT;PmRealVector mU;PmRealVector mV;PmRealVector mX;PmRealVector
mD;PmIntVector mE;PmRealVector mCR;PmIntVector mCI;}NeSystemInput;typedef enum
...
size_t mSizes[NE_NUM_SYSTEM_INPUT_ID];}NeSystemInputSizes;typedef struct
...
NE_NOMINAL_SOURCE_FIXED,NE_NOMINAL_SOURCE_NUM}NeNominalSource;
#ifdef __cplusplus
}
#endif /* __cplusplus */
#endif /* __ne_std_h__ */
