...
SIMULINK_EXPORT_FCN void slcsCatalogAddCallerAndStateOwnerInSameTask(
    SimStruct* S, const char *callerPath, const char *stateOwnerPath);

SIMULINK_EXPORT_FCN void slcsCatalogAddCallerAndStateAccessorInSameTask(
    SimStruct* S, const char *callerPath, const char *stateAccessorPath);

SIMULINK_EXPORT_FCN void slcsAddStateOwnerInsideFunction(
    SimStruct* S, const char *fcnName, const char *stateOwnerPath);

SIMULINK_EXPORT_FCN void slcsAddStateAccessorInsideFunction(
