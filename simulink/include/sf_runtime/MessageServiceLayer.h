...
LIBMWSF_RUNTIME_API void* slMessageRtRegisterLocalMessageQueueUsingMsgBlock(MsgBlockInfo_t* blkInfo, int queueId);
LIBMWSF_RUNTIME_API void* slMessageRtRegisterInputMessageQueueUsingMsgBlock(MsgBlockInfo_t* blkInfo, int portNum);
LIBMWSF_RUNTIME_API void* slMessageRtRegisterOutputMessageQueueUsingMsgBlock(MsgBlockInfo_t* blkInfo, int portNum);
