...
LIBMWSF_RUNTIME_API void sf_attempt_to_read_queue_overflow_var_before_pop_for_input_message_error(SimStruct* S, unsigned int ssIdOfSourceObject, int offsetInSourceObject, int lengthInSourceObject);
LIBMWSF_RUNTIME_API void sf_attempt_to_read_queue_overflow_var_before_send_for_output_message_error(SimStruct* S, unsigned int ssIdOfSourceObject, int offsetInSourceObject, int lengthInSourceObject);
LIBMWSF_RUNTIME_API void sf_attempt_to_read_queue_overflow_var_before_send_or_pop_for_local_message_error(SimStruct* S, unsigned int ssIdOfSourceObject, int offsetInSourceObject, int lengthInSourceObject);
