...
LIBMWSF_RUNTIME_API const mxArray* sf_mex_get_sfun_param(SimStruct* S, unsigned int paramIndex, unsigned int bStrict);
...
LIBMWSF_RUNTIME_API void sf_call_atomic_subchart_event_fcn(int fcnNumber, int ssIdNumber, SimStruct* S);
...
LIBMWSF_RUNTIME_API void sf_call_marshall_in_fcn_dynamic(SimStruct* S, const char* fcnInName, void* var, void* var2, void* var3, const char*  varName, const mxArray* value);
LIBMWSF_RUNTIME_API mxArray*  sf_call_marshall_out_fcn(SimStruct* S, const char* fcnOutName, void* var,const char* varName);
LIBMWSF_RUNTIME_API mxArray*  sf_call_marshall_out_fcn_dynamic(SimStruct* S, const char* fcnOutName, void* var, void* sizeFirst, void* sizeSecond, const char* varName);
